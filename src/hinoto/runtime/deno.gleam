...
/// Starts an HTTP server using Deno's runtime
///
...
/// deno.serve(my_fetch_handler, None, None)
///
/// // Start server on specific port
/// deno.serve(my_fetch_handler, Some(8080), None)
///
/// // Start server with custom hostname and port
/// deno.serve(my_fetch_handler, Some(8080), Some("localhost"))
/// ```
///
pub fn serve(
  fetch: fn(JsRequest) -> Promise(JsResponse),
